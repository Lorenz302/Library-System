...
// 1. Get user's active interactions
$user_status_map = [];

// FIX: Added 'Borrowed' to the check list.
// Now it checks: Is it Pending? Approved? OR currently Borrowed?
$sql_borrow = "SELECT book_id FROM borrow_requests WHERE id_number = ? AND borrow_status IN ('Pending', 'Approved', 'Borrowed')";
